 ...
 */
public class HeuLearnFromBFSExploreAction extends SimulatorAction {
    /** Constructs a new action, for a given simulator. */
    public HeuLearnFromBFSExploreAction(Simulator simulator, boolean animated) {
     ...
     */
    public Exploration explore(ExploreType exploreType,ExploringItem exploringItems,int maxNumberOfStates,boolean isLearningStep) {
        return explore(getSimulatorModel().getState(), exploreType,exploringItems,maxNumberOfStates,isLearningStep);
    }
     ...
     * failed for some reason
     */
    public Exploration explore(GraphState state, ExploreType exploreType,ExploringItem exploringItems,int maxNumberOfStates,boolean isLearningStep) {
        ...
        if(!exploringItems.callFromHeuGenerator){
            ...
            try {
                ...
                ExploreThread generateThread = new ExploreThread(result,exploringItems,maxNumberOfStates,isLearningStep);
                // go!
            ...
            try {
                SwingUtilities.invokeAndWait(new Runnable() {
                    ...
                    public void run() {
                        ...
                        dialog.setBound(HeuLearnFromBFSExploreAction.this.bound);
                        if (dialog.ask(getFrame())) {
                            HeuLearnFromBFSExploreAction.this.bound = dialog.getBound();
                        } else {
                            setInterrupted(true);
                        }
                    }
    ...
    private class ExploreThread extends Thread {
         ...
         */
        public ExploreThread(Exploration exploration,ExploringItem exploringItems,int maxNumberOfStates,boolean isLearningStep) {
        	if(!exploringItems.callFromHeuGenerator){
            ...
            this.exploringItems=exploringItems;
            this.maxNumberOfStates=maxNumberOfStates;
            this.isLearningStep=isLearningStep;
        }
        ...
        public void start() {
            ...
            if(exploringItems.isProgressVisible)
        ...
        final public void run() {
        	if(!exploringItems.callFromHeuGenerator) {
                ...
                this.exploration.heuristicLearnFBFSplay(gts, state, exploringItems,maxNumberOfStates,isLearningStep);
                if(exploringItems.isProgressVisible){
        		...
        		setInterrupted(false);
                this.exploration.heuristicLearnFBFSplay(exploringItems.gts, exploringItems.initialState, exploringItems,exploringItems.maxNumberOfStates,isLearningStep);
        	}
        ...
        private ExploringItem exploringItems;
