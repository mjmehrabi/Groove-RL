 ...
 */
public class RLExploreAction extends SimulatorAction {
    /** Constructs a new action, for a given simulator. */
    public RLExploreAction(Simulator simulator, boolean animated) {
     ...
     */
    public Exploration explore(ExploreType exploreType,ExploringItemRL exploringItems) {
     ...
     * failed for some reason
     */
    public Exploration explore(GraphState state, ExploreType exploreType,ExploringItemRL exploringItems) {
            ...
            try {
                SwingUtilities.invokeAndWait(new Runnable() {
                    ...
                    public void run() {
                        ...
                        dialog.setBound(RLExploreAction.this.bound);
                        if (dialog.ask(getFrame())) {
                            RLExploreAction.this.bound = dialog.getBound();
                        } else {
                            setInterrupted(true);
                        }
                    }
    ...
    private class ExploreThread extends Thread {
         ...
         */
        public ExploreThread(Exploration exploration,ExploringItemRL exploringItems) {
            if(!exploringItems.callFromHeuGenerator){
        ...
        final public void run() {
            if(!exploringItems.callFromHeuGenerator) {
                ...
                this.exploration.RLplay(gts, state, exploringItems);
                if(exploringItems.isProgressVisible){
                ...
                setInterrupted(false);
                this.exploration.RLplay(exploringItems.gts, exploringItems.initialState, exploringItems);
            }
        ...
        private ExploringItemRL exploringItems;
    }
