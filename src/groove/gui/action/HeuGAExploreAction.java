 ...
 */
public class HeuGAExploreAction extends SimulatorAction {
    /** Constructs a new action, for a given simulator. */
    public HeuGAExploreAction(Simulator simulator, boolean animated) {
            ...
            try {
                SwingUtilities.invokeAndWait(new Runnable() {
                    ...
                    public void run() {
                        ...
                        dialog.setBound(HeuGAExploreAction.this.bound);
                        if (dialog.ask(getFrame())) {
                            HeuGAExploreAction.this.bound = dialog.getBound();
                        } else {
                            setInterrupted(true);
                        }
                    }
    ...
    private class ExploreThread extends Thread {
        ...
        final public void run() {
        	if(!exploreGaBayesNet.callFromHeuGenerator) {
                ...
                this.exploration.heuristicGAplay(gts, state, exploreGaBayesNet);
                if(exploreGaBayesNet.isProgressVisible){
        		...
        		setInterrupted(false);
        		this.exploration.heuristicGAplay(exploreGaBayesNet.gts, exploreGaBayesNet.initialState, exploreGaBayesNet);
        	}
