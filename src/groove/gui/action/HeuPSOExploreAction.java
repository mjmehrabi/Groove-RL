 ...
 */
public class HeuPSOExploreAction extends SimulatorAction {
    /** Constructs a new action, for a given simulator. */
    public HeuPSOExploreAction(Simulator simulator, boolean animated) {
     ...
     */
    public Exploration explore(ExploreType exploreType,ExploringItemPSO exploringItemPSO) {
        return explore(getSimulatorModel().getState(), exploreType,exploringItemPSO);
    }
     ...
     * failed for some reason
     */
    public Exploration explore(GraphState state, ExploreType exploreType,ExploringItemPSO exploringItemPSO) {
        ...
        if(!exploringItemPSO.callFromHeuGenerator){
            ...
            try {
                ...
                ExploreThread generateThread = new ExploreThread(result,exploringItemPSO);
                // go!
                ...
                if(exploringItemPSO.heuristicResult==null && !exploringItemPSO.ModelCheckingTarget.equals("DeadLock"))
            ...
            try {
                SwingUtilities.invokeAndWait(new Runnable() {
                    ...
                    public void run() {
                        ...
                        dialog.setBound(HeuPSOExploreAction.this.bound);
                        if (dialog.ask(getFrame())) {
                            HeuPSOExploreAction.this.bound = dialog.getBound();
                        } else {
                            setInterrupted(true);
                        }
                    }
    ...
    private class ExploreThread extends Thread {
         ...
         */
        public ExploreThread(Exploration exploration,ExploringItemPSO exploringItemPSO) {
        	if(!exploringItemPSO.callFromHeuGenerator){
            ...
            this.exploringItemPSO=exploringItemPSO;
        }
        ...
        public void start() {
            ...
            if(exploringItemPSO.isProgressVisible)
        ...
        final public void run() {
        	if(!exploringItemPSO.callFromHeuGenerator) {
                ...
                this.exploration.heuristicPSOplay(gts, state, exploringItemPSO);
                if(exploringItemPSO.isProgressVisible){
        		...
        		setInterrupted(false);
        		this.exploration.heuristicPSOplay(exploringItemPSO.gts, exploringItemPSO.initialState, exploringItemPSO);
        	}
        ...
        private ExploringItemPSO exploringItemPSO;
    }
